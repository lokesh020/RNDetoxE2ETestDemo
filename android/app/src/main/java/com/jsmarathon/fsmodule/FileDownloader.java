...
public  class FileDownloader extends AsyncTask<FileDownloadParams, long[], FileDownloadResult> {
    private FileDownloadParams mParam;
    private AtomicBoolean mAbort = new AtomicBoolean(false);
    FileDownloadResult res;

    protected FileDownloadResult doInBackground(FileDownloadParams... params) {
        mParam = params[0];
        res = new FileDownloadResult();
    ...
    private void download(FileDownloadParams param, FileDownloadResult res) throws Exception {
